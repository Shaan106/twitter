...
- Concrete objects and situations beat abstract observations about society.
...
1. Where is the actual surprise? If there is only an opinion, it is probably not ready.
2. Can a stranger understand the premise without our chat history?
3. Can the opening be shorter without losing the setup?
4. Does the final clause sharpen the joke or explain it? Cut explanations.
5. Is the phrase familiar because it is a stock internet joke? Search a distinctive fragment before choosing a lead post; a search with no match is not proof of originality.
6. Could another joke in our recent queue substitute for this one unchanged? If yes, the voice is getting repetitive.
